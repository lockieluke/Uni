...
export default function ColumnTrigger({children, className, onPress, subpage = false}: {
    ...
    return (<TouchableOpacity activeOpacity={0.8} onPress={() => onPress?.()} className={cn("bg-slate-200 dark:bg-zinc-900 w-[90vw] flex flex-row justify-between items-center p-4 rounded-lg", className)}>
